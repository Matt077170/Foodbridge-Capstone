...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $stmt = $conn->prepare("INSERT INTO users (fullname, address, contact, email, password, role, status) VALUES (?, ?, ?, ?, ?, 'donor', 'pending')");
    $stmt->bind_param("sssss", $name, $address, $contact, $email, $password);
    $stmt->execute();
...
<head>
  ...
  <title>Sign up for Donor</title>
  <link rel="stylesheet" href="../css/register_donor.css">
