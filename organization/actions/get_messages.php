<?php
// FILE: organization/actions/get_messages.php
session_start();
include '../../includes/db.php';

header('Content-Type: application/json');

if (!isset($_SESSION['user']) || $_SESSION['user']['role'] !== 'organization' || !isset($_GET['recipient_id'])) {
...
$update_stmt->bind_param("ii", $recipient_id, $org_id);
$update_stmt->execute();
$update_stmt->close();
...
$stmt->bind_param("iiii", $org_id, $recipient_id, $recipient_id, $org_id);
$stmt->execute();
